...
export default function AlertsWidget() {
  return <div className="space-y-3">
      {alerts.map(alert => <div key={alert.id} className="flex items-start p-3 rounded-lg bg-gray-50 border border-gray-200 dark:bg-gray-700 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-opacity-70 transition-all">
          <div className="mr-3">
          ...
          <div>
            <div className="flex items-center mb-1">
              ...
              <span className="ml-2 text-xs bg-gray-200 dark:bg-gray-600 px-1.5 py-0.5 rounded">
                {alert.ticker}
              </span>
            </div>
      ...
      {alerts.length === 0 && <div className="text-center py-4 text-gray-500 dark:text-gray-400">
